...
;
menuButton.addEventListener('click', menuButtonClickHandler); // document.body.addEventListener('click', evt => {
//   alert('body');
...
function initMap() {
  ...
  var mapControl = new MapControl(mapControlDiv, map); //---------------------------------------Объект данных---------------------------------------
  ...
  var polylinesHidden = false; //---------------------Убрать все полилинии кроме одной--------------------
