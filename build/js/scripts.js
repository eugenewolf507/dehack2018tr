...
var polylines = []; //---------------------Function add markers on map--------------------
...
function initMap() {
  ...
  google.maps.event.addDomListener(parking, "click", function () {
    if (!parkingHandle) {
      ...
      coordinatesParkingMarkers.map(function (coordinate) {
        return addMarker(coordinate, arrayParkingMarkers, icon);
      });
      parkingHandle = true;
    } else {
  ...
  google.maps.event.addDomListener(cafe, "click", function () {
    if (!cafeHandle) {
      ...
      coordinatesCafeMarkers.map(function (coordinate) {
        return addMarker(coordinate, arrayCafeMarkers, icon);
      });
      cafeHandle = true;
    } else {
  ...
  google.maps.event.addDomListener(sight, "click", function () {
    if (!sightHandle) {
      ...
      coordinatesSightMarkers.map(function (coordinate) {
        return addMarker(coordinate, arraySightMarkers, icon);
      });
      sightHandle = true;
    } else {
  ...
  var _loop = function _loop(key) {
    routes[key].coords.forEach(function (item, idx) {
  ...
  var polylinesHidden = false; //---------------------Remove all polylines except one--------------------
...
var menuItem = document.querySelector(".burger-list__item");
var subMenu = document.querySelector(".subrotes");
var subMenusArr = document.querySelectorAll(".subrotes");
var subMenuItem = document.querySelectorAll(".subrotes__item");
var menuHandle = false;

function menuButtonClickHandler() {
  menu.classList.toggle("hidden-menu");
}

menuButton.addEventListener("click", menuButtonClickHandler); //---------------------The appearance and disappearance of the menu when you click menu button END--------------------
//---------------------Remove the menu when clicking on the map START--------------------

function mapClickHandlerRemoveMenu() {
  menu.classList.remove("hidden-menu");
  subMenusArr.forEach(function (elem) {
...
map.addEventListener("click", mapClickHandlerRemoveMenu); //---------------------Remove the menu when clicking on the map END--------------------
//-------------------The appearance and disappearance submenu----------

function menuItemClickHandler(_ref) {
...
;
menu.addEventListener("click", menuItemClickHandler); //--Hadling array polylines on click to sumbenu----
...
function subMenuItemClickHandler(_ref2) {
...
subMenuItem.forEach(function (item) {
  return item.addEventListener("click", subMenuItemClickHandler);
});
"use strict";

//-------Click open traffic-section listeners------open section from menu-----
var subrotesId = '';
console.log("+++"); //---------------------Click open traffic-section listeners--------------------

var menuSvg = document.querySelector(".ham");
document.getElementById("burger-list").addEventListener("click", function (event) {
  console.log("++");
  ...
  if (event.target.matches("#pinePark")) {
    console.log("+");
    document.getElementById("rout-footer").classList.remove("traffic--hidden");
    return;
  }
...
document.getElementById("accident-close").addEventListener("click", function () {
  document.getElementById("accident-section").classList.add("traffic--hidden");
});
document.querySelector(".routothercyclists-section__closebutton").addEventListener("click", function () {
  document.getElementById("routothercyclists-section").classList.add("traffic--hidden");
...
document.getElementById("burger-list").addEventListener("click", function (event) {
  if (event.target.parentNode.classList.contains("subrotes")) {
    ...
    console.log(subrotesId); // return event.target.id;
  }
}); //---------------------Get subrotes__item id END--------------------
//---------------------Show subrote modal window START--------------------

document.getElementById("rout-footer").addEventListener("click", function (event) {
  console.log(subrotesId); // return event.target.id;

  document.getElementById("routothercyclists-section") //need use subrotesId
