...
var arrayGeotagMarkers = []; //---------------------Function add markers on map--------------------
...
document.getElementById("burger-list").addEventListener("click", function (event) {
  if (event.target.matches("#trafficcontrol")) {
    document.getElementById("control-section").classList.remove("traffic-section--hidden");
    return;
  }

  if (event.target.matches("#trafficaccident")) {
    document.getElementById("accident-section").classList.remove("traffic-section--hidden");
    return;
  }

  if (event.target.matches("#pinePark")) {
    document.getElementById("routothercyclists-section").classList.remove("traffic-section--hidden");
    return;
  }
}); //---------------------Click close traffic-section listeners--------------------

document.getElementById("control-close").addEventListener("click", function () {
  document.getElementById("control-section").classList.add("traffic-section--hidden");
});
document.getElementById("accident-close").addEventListener("click", function () {
  document.getElementById("accident-section").classList.add("traffic-section--hidden");
});
document.querySelector(".routothercyclists-section__closebutton").addEventListener("click", function () {
  document.getElementById("routothercyclists-section").classList.add("traffic-section--hidden");
});